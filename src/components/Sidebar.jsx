        ...
        <>
            ...
            {open &&
                <div className='flex flex-col lg:hidden h-screen w-[300px] fixed z-[98] bg-[#2c1f14] bg-opacity-75 backdrop-blur-lg p-[75px] pt-[100px] gap-[40px] text-4xl '>
                    ...
                    <Link to="https://areteco.agency/form" className='p-[05px] bg-[--HTextColor] rounded-md font-bold text-3xl flex items-center justify-center uppercase hover:scale-[1.02]'>Get Started</Link>
                </div>
            }
        </>
    )
